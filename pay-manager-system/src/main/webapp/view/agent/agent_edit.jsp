...
<div class="modal-body">
    <div class="bootbox-body">
        ...
        <form id="editAgentForm" action="${baseURL}/agent/updateAgent" class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8">
                    <input id="editAgentName" name="agentName" check-type="required"
                           type="text" class="form-control" maxlength="255" placeholder="请输入代理名称"/>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#editAgentForm').validation();            //表单验证初始化
