...
<div class="modal-header">
    ...
    <h4 class="modal-title">请先输入提现密码</h4>
</div>

<div class="modal-body">
    <div class="bootbox-body">

        <form id="checkWithdrawPassword" action="${baseURL}/finance/withdraw/checkWithdrawPassword" class="form-horizontal">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#checkWithdrawPassword').validation();
