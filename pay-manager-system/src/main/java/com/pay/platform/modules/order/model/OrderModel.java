...
public class OrderModel extends BaseModel {
    ...
    private Integer notifiyNum;                //通知次数
    ...
    public Integer getNotifiyNum() {
        return this.notifiyNum;
    }

    public void setNotifiyNum(Integer notifiyNum) {
        this.notifiyNum = notifiyNum;
    }
