...
<div class="modal-body">
    <div class="bootbox-body">
        ...
        <form id="edit${classPrefix}Form" action="<@jspEl "baseURL" />${requestUrl}/update${classPrefix}" class="form-horizontal">
            ...
            <input type="hidden" name="id" value="<@jspEl "param.id" />" />
                    ...
                    <#if column.formType == "text" >
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input name="${column.fieldName}"  id="edit${column.fieldName?cap_first}" <#if column._isRequired >check-type="required"</#if> value="<@jspEl value='${propertyPrefix}.${column.fieldName}' />" type="text" class="form-control"  maxlength="${column.size}" placeholder="请输入${column.remarks}" />
                            </div>
                        </div>
                    <#-- 日期类型 -->
