package com.pay.platform.common.plugins.mybatis;

import com.pay.platform.modules.sysmgr.role.controller.RoleController;
...
public class PackagesSqlSessionFactoryBean extends SqlSessionFactoryBean {
    ...
    public void setTypeAliasesPackage(String typeAliasesPackage) {
        ...
        try {
            ...
            if(result.size() > 0) {
                super.setTypeAliasesPackage(StringUtils.collectionToDelimitedString(result, ","));
            }else{
