...
/**
 * User: zjt
 * DateTime: 2019/7/15 17:32
 */
public class PushTest {

    DefaultProfile profile = DefaultProfile.getProfile("cn-shenzhen", "LTAIUtjarh3d9lYE", "gU8hW4eJ4AOM22OdHR4jLxJzmdKtIp");
    IAcsClient client = new DefaultAcsClient(profile);

    Long appKey = 27669759L;
    String deviceIds = "";
