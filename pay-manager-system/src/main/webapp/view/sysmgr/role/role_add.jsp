...
<div class="modal-body">
    <div class="bootbox-body">
        ...
        <form id="addRoleForm" action="${baseURL}/sysmgr/role/addRole" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8">
                    <input name="name" type="text" class="form-control" check-type="required" maxlength="30" placeholder="请输入角色名称"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8">
                    <input name="code" type="text" class="form-control" check-type="required" maxlength="30" placeholder="请输入角色码"/>
                </div>
            </div>
