...
public class AppSecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            BaseService baseService = AppContext.getApplicationContext().getBean(BaseService.class);
            Map<String, Object> tradeCodeInfo = baseService.queryTradeCodeByCudeNum(codeNum);
